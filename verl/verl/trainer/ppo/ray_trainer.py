...
from verl.trainer.ppo.opd_consistency import run_opd_consistency_pipeline
                    ...
                    with marked_timer("reward", timing_raw, color="yellow"):
                        ...
                        if self.use_rm and "rm_scores" not in batch.batch.keys():
                            ...
                            if top_k > 0:
                                ...
                                with marked_timer("opd_consistency", timing_raw, color="purple"):
                                    batch, opd_pipeline_metrics = run_opd_consistency_pipeline(
                                        batch=batch,
                                    ...
                                    metrics.update(opd_pipeline_metrics)
